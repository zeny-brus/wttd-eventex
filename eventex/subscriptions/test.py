...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['visitor@email.com', 'fulano@email.com']
        self.assertEqual(expect, email.to)

    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Fulano Ciclano', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('fulano@email.com', email.body)
        self.assertIn('00-999999999', email.body)
